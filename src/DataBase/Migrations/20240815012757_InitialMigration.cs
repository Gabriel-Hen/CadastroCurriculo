    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Curricolums", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Curricolums_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    CurricolumId = table.Column<int>(type: "int", nullable: false),
                    Name = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Courses_Curricolums_CurricolumId",
                        column: x => x.CurricolumId,
                        principalTable: "Curricolums",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProfessionalExperiences_Curricolums_CurricolumId",
                        column: x => x.CurricolumId,
                        principalTable: "Curricolums",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Courses_CurricolumId",
                table: "Courses",
                column: "CurricolumId");

            migrationBuilder.CreateIndex(
                name: "IX_Curricolums_UserId",
                table: "Curricolums",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_ProfessionalExperiences_CurricolumId",
